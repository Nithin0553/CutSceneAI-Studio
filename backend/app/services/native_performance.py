...
class NativePerformanceRealizer:
    ...
    def _stage_unity(
        ...
        *,
        ...
        runtime_relative = "Assets/CutSceneAI/Runtime/CutSceneAIBodyStreamDriver.cs"
        self._write_managed_text(
            Path(record.project_path) / runtime_relative,
            render_unity_body_stream_runtime_script(),
            marker="// Generated by CutSceneAI Unity Adapter runtime support",
        )
