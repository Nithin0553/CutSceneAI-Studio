...
def test_compiles_exact_bundle_and_renders_strict_unity_editor_harness() -> None:
    ...
    for token in (
        ...
        "CutSceneAIHumanoidIKDriver.PoseFrame",
        ...
        'retargeting_method = "humanoid-ik-full-limbs-v1+humanoid-avatar+generic-direct-bone-fallback-v1+actor-motion-root-v3-authored-transform"',
    ...
    for token in (
        ...
        "public sealed class CutSceneAIHumanoidIKDriver",
        "AnimationHumanStream human = stream.AsHuman()",
        "human.ResetToStancePose()",
        "human.SetGoalLocalPosition(AvatarIKGoal.LeftFoot",
        "human.SetGoalLocalPosition(AvatarIKGoal.RightHand",
