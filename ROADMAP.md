...
| 3 | Dialogue Engine v0.1 - in acceptance | Recorded-audio ingestion, pluggable TTS, voice metadata, provenance, and exact WAV duration calculation | Recorded and generated bundles carry stable CIR audio URIs plus deterministic start/end seconds and frames without changing CIR 0.1 scene pacing |
