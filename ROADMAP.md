...
| 4 | Unreal Adapter v0.6 - portable dialogue import - complete | Verify Dialogue v0.1 bundles, import their WAV files without replacement, resolve portable URIs, and preserve manifest timing | A generated dialogue ZIP creates checksum-verified Sound Waves and exact Sequencer sections that play at their manifest ranges with no importer or playback errors |
| 5 | Asset Resolver and Environment v0.1 with Unreal v0.7 - current | Project asset index, deterministic matching, props, sets, and environment-detail and establishing shots | Office and outdoor fixtures resolve assets predictably with visible fallbacks |
